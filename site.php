...
$app->get("/checkout", function(){
	...
	if (!$address->getdescontry()) $address->setdescountry('');
...
$app->post("/checkout", function(){
	...
	exit;*/ // Como estava antes do PagSeguro e PayPal
